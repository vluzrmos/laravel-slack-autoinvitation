 ...
 * Generated for Laravel 5.0.23 on 2015-04-07.
 *
...
namespace {
    ...
    class SlackApi extends \Vluzrmos\SlackApi\SlackApiFacade{
         ...
         * @param string $url
         * @param array $parameters
         * @return \Vluzrmos\SlackApi\mixed; 
         * @static 
         */
        public static function method($method = 'get', $url = '', $parameters = array()){
            return \Vluzrmos\SlackApi\SlackApi::method($method, $url, $parameters);
        }
        ...
        public static function get($apiMethod, $parameters = array()){
            return \Vluzrmos\SlackApi\SlackApi::get($apiMethod, $parameters);
        }
        ...
        public static function post($apiMethod, $parameters = array()){
            return \Vluzrmos\SlackApi\SlackApi::post($apiMethod, $parameters);
        }
        ...
        public static function put($apiMethod, $parameters = array()){
            return \Vluzrmos\SlackApi\SlackApi::put($apiMethod, $parameters);
        }
        ...
        public static function delete($apiMethod, $parameters = array()){
            return \Vluzrmos\SlackApi\SlackApi::delete($apiMethod, $parameters);
        }
        ...
        public static function patch($apiMethod, $parameters = array()){
            return \Vluzrmos\SlackApi\SlackApi::patch($apiMethod, $parameters);
        }
        ...
        public static function setToken($token){
            return \Vluzrmos\SlackApi\SlackApi::setToken($token);
        }
         ...
         * @static 
         */
        public static function setClient($client = null, $verify = null){
            return \Vluzrmos\SlackApi\SlackApi::setClient($client, $verify);
        }
         ...
         * @static 
         */
        public static function setSSLVerifyPath($path = null){
            return \Vluzrmos\SlackApi\SlackApi::setSSLVerifyPath($path);
        }
         ...
         * @static 
         */
        public static function getSSLVerifyPath(){
            return \Vluzrmos\SlackApi\SlackApi::getSSLVerifyPath();
        }
        ...
        public static function getClient(){
            return \Vluzrmos\SlackApi\SlackApi::getClient();
        }
         ...
         */
        public static function macro($name, $macro){
            \Vluzrmos\SlackApi\SlackApi::macro($name, $macro);
        }
         ...
         */
        public static function hasMacro($name){
            return \Vluzrmos\SlackApi\SlackApi::hasMacro($name);
        }
